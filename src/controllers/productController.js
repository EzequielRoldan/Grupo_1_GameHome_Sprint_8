...
const productController = {
    ...
    store: (req, res) => {
        ...
        .then(
            ([brands,colors,categories]) => {
                res.render('products/productAdd',{user:req.session.user , brands,colors,categories,errors:resulValidation.mapped()})
            }
        )
    }
    },
	...
	update: (req, res) => {
        ...
        let id=req.params.id;
           ...
           .then(([producto,colors,categories,brands])=>
            {
                res.render('products/editProduct',{user:req.session.user,producto,colors,categories,brands,old:req.body,errors:resulValidation.mapped()})
            })
    }
